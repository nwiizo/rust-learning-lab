---
name: learn-rust
description: Rust初学者の構文・コードの読み方やコンパイルエラーを、構文の役割と背景、型・所有権の動き、小さな例から説明する。つまずきに応じてコード追跡・想起・練習で理解と定着を支える。実装だけの依頼や専門家向けレビューでは説明を増やさない。
---
...
ユーザーの言語で説明する。この資料の日本語に回答言語を固定しない。
